    ...
    let newRow = '<div class="textarea-row" id="' + newID + '">' +
                    ...
                    '<div class="textarea-actions">' +
                        '<div class="textarea-buttons">' +
                            '<button class="btn buttons synthesizeText" id="' + newID + 'L" onclick="listenRow(this); return false;" data-tippy-content="Listen Text" ><svg width="51" height="50" viewBox="0 0 51 50" fill="none" xmlns="http://www.w3.org/2000/svg">\n' +
