		...
		<div class="row justify-content-md-center">
			<div class="col-sm-12 text-center d-flex justify-content-start align-items-center">
				<h3 class="card-title fs-28 mb-3 ">
				  <?php echo e(__('AI Chat CSV')); ?>

				</h3>
				<h6 class="mb-0 fs-12 text-muted"><?php echo e(__('Unleash the Power of your CSV documents with the help of AI')); ?></h6>
					...
					<div class="card-footer">
						<div class="row text-center">
							<div class="col-sm-12">
								...
								<a class="btn btn-primary pl-6 pr-6 fs-12 mt-1" id="upload-csv-button" href="javascript:void(0);"><?php echo e(__('Upload CSV File')); ?></a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="card-header">
						<div class="w-100 pt-2 pb-2">
							<div class="d-flex">
								...
								<div class="widget-user-name"><span class="font-weight-bold"><?php echo e(__('AI CSV')); ?></span><br><span class="text-muted"><?php echo e(__('CSV Analyst Expert')); ?></span></div>
							</div>
						</div>
								...
								<div id="chat-container">
									<div class="msg left-msg" id="intro-drop-box">
										...
										<div class="message-bubble">
											<div class="msg-text"><?php echo e(__('Hey there, I can help you get any insights out of your CSV documents, what would you like to know?')); ?></div>
										</div>
									</div>
									<div id="image-drop-box">
										<div class="image-drop-area text-center">
											<div class="msg left-msg text-center mt-9">
												<div class="message-img" style="background-image: url('/chats/csv.jpg')"></div>
												<div class="message-bubble">
													<div class="msg-text"><?php echo e(__('Hey there, I can help you with analyzing any CSV documents that share with me')); ?></div>
													<div class="msg-text"><?php echo e(__('Select and upload your CSV documents to get started')); ?></div>
												</div>
											</div>
										</div>
									</div>
