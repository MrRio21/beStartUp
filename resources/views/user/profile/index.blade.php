			...
			<div class="card border-0 p-3" id="dashboard-background">
                <div class="usbg p-2" style="height: 131px; border-radius: 16px">
                    <div class="d-flex flex-row justify-content-end align-items-end h-100" style="gap: 9px" id="profile-pages">
                        <a href="{{ route('user.profile.edit') }}" class="fs-13">
                        ...
                        <a href="{{ route('user.profile.defaults') }}" class="fs-13">
                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect width="22" height="22" rx="4" fill="#030506"/>
                        ...
                        <a href="{{ route('user.security') }}" class="fs-13">
                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect width="22" height="22" rx="4" fill="#030506"/>
                        ...
                        <a href="{{ route('user.security.2fa') }}" class="fs-13">
                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect width="22" height="22" rx="4" fill="#030506"/>
                        ...
                        <a href="{{ route('user.profile.delete') }}" class="fs-13">
                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect width="22" height="22" rx="4" fill="#030506"/>
                            ...
                            @if (config('settings.personal_openai_api') == 'allow' || config('settings.personal_sd_api') == 'allow')
                                <div class="">
                                    <div class="text-center pb-3">
                                        <a href="{{ route('user.profile.api') }}" class="fs-13">
                                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="22" height="22" rx="4" fill="#030506"/>
                                                <path d="M10.1193 5.29969L7.20842 6.39635C6.53759 6.64719 5.98926 7.44052 5.98926 8.15219V12.4864C5.98926 13.1747 6.44426 14.0789 6.99842 14.493L9.50676 16.3655C10.3293 16.9839 11.6826 16.9839 12.5051 16.3655L15.0134 14.493C15.5676 14.0789 16.0226 13.1747 16.0226 12.4864V8.15219C16.0226 7.43469 15.4743 6.64135 14.8034 6.39052L11.8926 5.29969C11.3968 5.11885 10.6034 5.11885 10.1193 5.29969Z" stroke="white" stroke-width="0.875" stroke-linecap="round" stroke-linejoin="round"/>
                                                <path d="M9.2793 10.9246L10.2185 11.8638L12.7268 9.35547" stroke="white" stroke-width="0.875" stroke-linecap="round" stroke-linejoin="round"/>
                ...
                <div class="widget-user-image overflow-hidden mx-auto mt-5" style="position: relative; top: -75px;"><img alt="User Avatar" class="rounded-circle" src="@if(auth()->user()->profile_photo_path){{ asset(auth()->user()->profile_photo_path) }} @else {{ URL::asset('img/users/avatar.jpg') }} @endif"></div>
				<div class="card-body text-center" style="position: relative ;top: -75px">
                    ...
                    <div class="card-foote row p-0 d-flex justify-content-center align-items-sm-center">
                        <div class="row col-6  text-center pt-4 pb-4 ">
                            <div class="col-sm">
                                <h4 class="mb-3 mt-1 font-weight-800  fs-16">@if (auth()->user()->available_words == -1) {{ __('Unlimited') }} @else {{ App\Services\HelperService::userAvailableWords() }} @endif</h4>
                                <h6 class="fs-12">{{ __('Words Left') }}</h6>
                            </div>
                            @role('user|subscriber|admin')
                            @if (config('settings.image_feature_user') == 'allow')
                                <div class="col-sm">
                                    <h4 class="mb-3 mt-1 font-weight-800  fs-16">@if (auth()->user()->available_images == -1) {{ __('Unlimited') }} @else {{ App\Services\HelperService::userAvailableImages() }} @endif</h4>
                        ...
                        @if (config('settings.voiceover_feature_user') == 'allow' || config('settings.whisper_feature_user') == 'allow')
                            <div class="row col-6 text-center pt-4 pb-4">
                                ...
                                @if (config('settings.voiceover_feature_user') == 'allow')
                                    <div class="col-sm">
                                        <h4 class="mb-3 mt-1 font-weight-800  fs-16">@if (auth()->user()->available_chars == -1) {{ __('Unlimited') }} @else {{ App\Services\HelperService::userAvailableChars() }} @endif</h4>
                                ...
                                @if (config('settings.whisper_feature_user') == 'allow')
                                    <div class="col-sm">
                                        <h4 class="mb-3 mt-1 font-weight-800  fs-16">@if (auth()->user()->available_minutes == -1) {{ __('Unlimited') }} @else {{ App\Services\HelperService::userAvailableMinutes() }} @endif</h4>
					...
					<div class="row">
							...
							<div class="card overflow-hidden border-0">
								<div class="card-body d-flex flex-column-reverse justify-content-start">
									<div class="usage-info w-100">
										<p class=" mb-3 fs-12 font-weight-bold text-left">{{ __('Documents Created') }}</p>
										<h2 class="mb-2 number-font fs-20 text-left">{{ number_format($data['contents']) }} <span class="text-muted fs-18">{{ __('documents') }}</span></h2>
									</div>
						...
						<div class="col-lg-4 col-md-6 col-sm-12">
							<div class="card overflow-hidden border-0">
								<div class="card-body d-flex flex-column-reverse justify-content-start">
									<div class="usage-info w-100">
										<p class=" mb-3 fs-12 font-weight-bold text-left">{{ __('Words Generated') }}</p>
										<h2 class="mb-2 number-font fs-20 text-left">{{ number_format($data['words']) }} <span class="text-muted fs-18">{{ __('words') }}</span></h2>
									</div>
									<div class="usage-icon text-left">
                                        <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <circle cx="28" cy="28" r="28" fill="#F4F7FE"/>
            				...
            				@if (config('settings.image_feature_user') == 'allow')
								<div class="col-lg-4 col-md-6 col-sm-12">
									<div class="card overflow-hidden border-0">
										<div class="card-body d-flex flex-column-reverse justify-content-start">
											<div class="usage-info w-100">
												<p class=" mb-3 fs-12 font-weight-bold text-left">{{ __('Images Created') }}</p>
												<h2 class="mb-2 number-font fs-20 text-left">{{ number_format($data['images']) }} <span class="text-muted fs-18">{{ __('images') }}</span></h2>
											</div>
											<div class="usage-icon text-left">
                                                <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <circle cx="28" cy="28" r="28" fill="#F4F7FE"/>
            				...
            				@if (config('settings.voiceover_feature_user') == 'allow')
								<div class="col-lg-4 col-md-6 col-sm-12">
									<div class="card overflow-hidden border-0">
										<div class="card-body d-flex flex-column-reverse justify-content-start">
											<div class="usage-info w-100">
												<p class=" mb-3 fs-12 font-weight-bold text-left">{{ __('Voiceover Tasks') }}</p>
												<h2 class="mb-2 number-font fs-20 text-left">{{ number_format($data['synthesized']) }} <span class="text-muted fs-18">{{ __('tasks') }}</span></h2>
											</div>
											<div class="usage-icon text-left">
                                                <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <circle cx="28" cy="28" r="28" fill="#F4F7FE"/>
            				...
            				@if (config('settings.whisper_feature_user') == 'allow')
								<div class="col-lg-4 col-md-6 col-sm-12">
									<div class="card overflow-hidden border-0">
										<div class="card-body d-flex flex-column-reverse justify-content-start">
											<div class="usage-info w-100">
												<p class=" mb-3 fs-12 font-weight-bold text-left">{{ __('Audio Transcribed') }}</p>
												<h2 class="mb-2 number-font fs-20 text-left">{{ number_format($data['transcribed']) }} <span class="text-muted fs-18">{{ __('audio files') }}</span></h2>
											</div>
											<div class="usage-icon text-left">
                                                <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <circle cx="28" cy="28" r="28" fill="#F4F7FE"/>
            				...
            				@if (config('settings.code_feature_user') == 'allow')
								<div class="col-lg-4 col-md-6 col-sm-12">
									<div class="card overflow-hidden border-0">
										<div class="card-body d-flex flex-column-reverse justify-content-start">
											<div class="usage-info w-100">
												<p class=" mb-3 fs-12 font-weight-bold text-left">{{ __('Codes Generated') }}</p>
												<h2 class="mb-2 number-font fs-20 text-left">{{ number_format($data['codes']) }} <span class="text-muted fs-18">{{ __('codes') }}</span></h2>
											</div>
											<div class="usage-icon text-left">
                                                <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <circle cx="28" cy="28" r="28" fill="#F4F7FE"/>
