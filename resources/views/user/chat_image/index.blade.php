...
<form id="openai-form" action="" method="GET" enctype="multipart/form-data" class="mt-24">
    ...
    <div class="row justify-content-md-center">
        <div class="col-sm-12 text-center d-flex justify-content-start align-items-center">
            <h3 class="card-title fs-28 mb-3"><?php echo e(__('Chat Image')); ?></h3>
            ...
            <div class="chat-message-container" id="chat-system">
                ...
                <div class="card-footer">
                    <div class="row justify-content-center">
                        <div class="col-sm-8"style="background: #f7f9fb; border-radius: 8px">
                            <div class="input-box mb-0">
                                <div class="chat-controllers">
                                        ...
                                        unset($__errorArgs, $__bag); ?>" rows="1" id="message" name="message"
                                                  placeholder="<?php echo e(__('Describe your image details here...')); ?>">
                                    ...
                                    <div>
                                        <button class="btn chat-button" id="chat-button"> <i
