										...
										<div class="input-box">
											...
											<select id="default-model-user" name="model" class="form-select" data-placeholder="<?php echo e(__('Select OpenAI Model Type')); ?>:">		
												...
												<?php $__currentLoopData = $models; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $model): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
													<option value="<?php echo e($model->model); ?>" <?php if( $id->model == $model->model): ?> selected <?php endif; ?>><?php echo e($model->description); ?> (Fine Tune Model)</option>
												<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
											</select>
										</div>
									</div>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">
											...
											<select id="default-model-chat-user" name="chat-model" class="form-select" data-placeholder="<?php echo e(__('Select OpenAI Model Type')); ?>:">		
												...
												<option value="gpt-4-1106-preview" <?php if( $id->model_chat == 'gpt-4-1106-preview'): ?> selected <?php endif; ?>><?php echo e(__('GPT 4 Turbo')); ?> (<?php echo e(__('Preview')); ?>)</option>
												<option value="gpt-4-vision-preview" <?php if( $id->model_chat == 'gpt-4-vision-preview'): ?> selected <?php endif; ?>><?php echo e(__('GPT 4 Turbo with Vision')); ?> (<?php echo e(__('Preview')); ?>)</option>
												<?php $__currentLoopData = $models; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $model): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
													<option value="<?php echo e($model->model); ?>" <?php if( $id->model_chat == $model->model): ?> selected <?php endif; ?>><?php echo e($model->description); ?> (Fine Tune Model)</option>
												<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
											</select>
										</div>
									</div>
...
unset($__errorArgs, $__bag); ?>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">
											...
											<select id="personal-openai-api" name="personal-openai-api" class="form-select">
												<option value=1 <?php if($id->personal_openai_api == true): ?> selected <?php endif; ?>><?php echo e(__('Allow')); ?></option>
												<option value=0 <?php if($id->personal_openai_api == false): ?> selected <?php endif; ?>><?php echo e(__('Deny')); ?></option>																																																																																																								
											</select>
										</div>
									</div>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">
											...
											<select id="personal-sd-api" name="personal-sd-api" class="form-select">
												<option value=1 <?php if($id->personal_sd_api == true): ?> selected <?php endif; ?>><?php echo e(__('Allow')); ?></option>
												<option value=0 <?php if($id->personal_sd_api == false): ?> selected <?php endif; ?>><?php echo e(__('Deny')); ?></option>																																																																																																								
											</select>
										</div>
									</div>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">
											...
											<select id="wizard-feature" name="wizard-feature" class="form-select">
												<option value=1 <?php if($id->wizard_feature == true): ?> selected <?php endif; ?>><?php echo e(__('Allow')); ?></option>
												<option value=0 <?php if($id->wizard_feature == false): ?> selected <?php endif; ?>> <?php echo e(__('Deny')); ?></option>																															
											</select>
										</div>
									</div>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">
											...
											<select id="vision-feature" name="vision-feature" class="form-select">
												<option value=1 <?php if($id->vision_feature == true): ?> selected <?php endif; ?>><?php echo e(__('Allow')); ?></option>
												<option value=0 <?php if($id->vision_feature == false): ?> selected <?php endif; ?>> <?php echo e(__('Deny')); ?></option>																															
											</select>
										</div>
									</div>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">
											<h6><?php echo e(__('Chat Image Feature')); ?> <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
											<select id="chat-image-feature" name="chat-image-feature" class="form-select">
												<option value=1 <?php if($id->chat_image_feature == true): ?> selected <?php endif; ?>><?php echo e(__('Allow')); ?></option>
												<option value=0 <?php if($id->chat_image_feature == false): ?> selected <?php endif; ?>> <?php echo e(__('Deny')); ?></option>																															
											</select>
										</div>
									</div>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">
											<h6><?php echo e(__('Chat PDF Feature')); ?> <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
											<select id="chat-pdf-feature" name="chat-pdf-feature" class="form-select">
												<option value=1 <?php if($id->chat_pdf_feature == true): ?> selected <?php endif; ?>><?php echo e(__('Allow')); ?></option>
												<option value=0 <?php if($id->chat_pdf_feature == false): ?> selected <?php endif; ?>> <?php echo e(__('Deny')); ?></option>																															
											</select>
										</div>
									</div>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">
											...
											<select id="internet-feature" name="internet-feature" class="form-select">
												<option value=1 <?php if($id->internet_feature == true): ?> selected <?php endif; ?>><?php echo e(__('Allow')); ?></option>
												<option value=0 <?php if($id->internet_feature == false): ?> selected <?php endif; ?>> <?php echo e(__('Deny')); ?></option>																															
											</select>
										</div>
									</div>
...
unset($__errorArgs, $__bag); ?>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">
											...
											<select id="chat-web-feature" name="chat-web-feature" class="form-select">
												<option value=1 <?php if($id->chat_web_feature == true): ?> selected <?php endif; ?>><?php echo e(__('Allow')); ?></option>
												<option value=0 <?php if($id->chat_web_feature == false): ?> selected <?php endif; ?>> <?php echo e(__('Deny')); ?></option>																															
											</select>
										</div>
									</div>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">
											...
											<select id="chat-csv-feature" name="chat-csv-feature" class="form-select">
												<option value=1 <?php if($id->chat_csv_feature == true): ?> selected <?php endif; ?>><?php echo e(__('Allow')); ?></option>
												<option value=0 <?php if($id->chat_csv_feature == false): ?> selected <?php endif; ?>> <?php echo e(__('Deny')); ?></option>																															
											</select>
										</div>
									</div>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">
											...
											<select id="smart-editor-feature" name="smart-editor-feature" class="form-select">
												<option value=1 <?php if($id->smart_editor_feature == true): ?> selected <?php endif; ?>><?php echo e(__('Allow')); ?></option>
												<option value=0 <?php if($id->smart_editor_feature == false): ?> selected <?php endif; ?>> <?php echo e(__('Deny')); ?></option>																															
											</select>
										</div>
									</div>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">
											...
											<select id="rewriter-feature" name="rewriter-feature" class="form-select">
												<option value=1 <?php if($id->rewriter_feature == true): ?> selected <?php endif; ?>><?php echo e(__('Allow')); ?></option>
												<option value=0 <?php if($id->rewriter_feature == false): ?> selected <?php endif; ?>> <?php echo e(__('Deny')); ?></option>																															
											</select>
										</div>
									</div>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">							
										<div class="input-box">								
											...
											<div class="form-group">							    
												<input type="number" class="form-control" min="1" id="chat-csv-file-size" name="chat-csv-file-size" min=0 value="<?php echo e($id->chat_csv_file_size); ?>">
...
unset($__errorArgs, $__bag); ?>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">							
										<div class="input-box">								
											...
											<div class="form-group">							    
												<input type="number" class="form-control" min="1" id="chat-pdf-file-size" name="chat-pdf-file-size" min=0 value="<?php echo e($id->chat_pdf_file_size); ?>">
												<span class="text-muted fs-10"><?php echo e(__('Maximum Size limit is in Megabytes (MB)')); ?>.</span>
											</div> 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u312848366/domains/bestartup.ai/public_html/resources/views/admin/finance/plans/edit.blade.php ENDPATH**/ ?>