...
<form id="openai-form" action="" method="post" enctype="multipart/form-data" class="mt-24"> 		
  ...
  <div class="row">
        <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12">
            <div class="card border-0" id="template-input" style="height: 97%">
                <div class="card-body p-5 pb-0 rounded">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <select id="language" name="language" class="form-select"
                                        data-placeholder="<?php echo e(__('Select input language')); ?>">
                                    <?php $__currentLoopData = $languages;
                                    $__env->addLoop($__currentLoopData);
                                    foreach ($__currentLoopData as $language): $__env->incrementLoopIndices();
                                        $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($language->language_code); ?>"
                                                data-img="<?php echo e(URL::asset($language->language_flag)); ?>" <?php if (auth()->user()->default_template_language == $language->language_code): ?> selected <?php endif; ?>> <?php echo e($language->language); ?></option>
                                    <?php endforeach;
                                    $__env->popLoop();
                                    $loop = $__env->getLastLoop(); ?>
                                </select>
                        ...
                        <div class="col-sm-12">
                            <div class="input-box">
                                <h6 class="fs-11 mb-2 font-weight-semibold"><?php echo e(__('Target Text')); ?> <span
                                        class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
                                <div class="form-group">
									<textarea rows="15" cols="50" type="text"
                                              ...
                                              unset($__errorArgs, $__bag); ?>" id="prompt" name="prompt"
                                              placeholder="<?php echo e(__('Paste your text that you wish to rewrite or improve...')); ?>"
                                              required></textarea>
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12">
                            <div id="form-group">
                                <h6 class="fs-11 mb-2 font-weight-semibold"><?php echo e(__('Creativity')); ?> <i
                                        class="ml-1 text-dark fs-12 fa-solid fa-circle-info"
                                        data-tippy-content="<?php echo e(__('Increase or decrease the creativity level to get various results')); ?>"></i>
                                </h6>
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12">
                            <div id="form-group">
                                <h6 class="fs-11 mb-2 font-weight-semibold"><?php echo e(__('Tone of Voice')); ?> <i
                                        class="ml-1 text-dark fs-12 fa-solid fa-circle-info"
                                        data-tippy-content="<?php echo e(__('Set result tone of the text as needed')); ?>"></i>
                                </h6>
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 mt-5">
                            <div id="form-group">
                                ...
                                <select id="view_point" name="view_point" class="form-select">
                                    <option value="none"><?php echo e(__('Default')); ?></option>
                                    <option value="first"><?php echo e(__('First Person')); ?></option>
                                    <option value="second"> <?php echo e(__('Second Person')); ?></option>
                                    <option value="third"> <?php echo e(__('Third Person')); ?></option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12">
                            <div class="input-box mt-5">
                                <h6 class="fs-11 mb-2 font-weight-semibold"><?php echo e(__('Number of Results')); ?> <i
                                        class="ml-1 text-dark fs-12 fa-solid fa-circle-info"
                                        data-tippy-content="<?php echo e(__('Maximum supported results is 50')); ?>"></i>
                                </h6>
                                <div class="form-group">
                                    ...
                                    unset($__errorArgs, $__bag); ?>" id="max_results" name="max_results"
                                           placeholder="e.g. 5" max="50" min="1" value="1">
                    ...
                    <div class="card-footer border-0 text-center p-0">
                        <div class="w-100 pt-2 pb-2">
                            <div class="text-center">
                                <button type="submit" name="submit" class="btn btn-primary  pl-9 pr-9 fs-11 pt-2 pb-2"
                                        id="generate"><?php echo e(__('Rewrite')); ?></button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-body p-5">
                            ...
                            <div class="input-box mb-2">
                                <div class="form-group">
                                    ...
                                    unset($__errorArgs, $__bag); ?>" id="document" name="document"
                                           value="<?php echo e(__('New Document')); ?>">
                        ...
                        <div class="col-lg-4 col-md-12 col-sm-12">
                            <div class="form-group">
                                <select id="project" name="project" class="form-select"
                                    ...
                                    <?php $__currentLoopData = $workbooks;
                                    $__env->addLoop($__currentLoopData);
                                    foreach ($__currentLoopData as $workbook): $__env->incrementLoopIndices();
                                        $loop = $__env->getLastLoop(); ?>
                                        <option
                                            value="<?php echo e($workbook->name); ?>" <?php if (strtolower(auth()->user()->workbook) == strtolower($workbook->name)): ?> selected <?php endif; ?>> <?php echo e(ucfirst($workbook->name)); ?></option>
                                    <?php endforeach;
                                    $__env->popLoop();
                                    $loop = $__env->getLastLoop(); ?>
                                </select>
                                ...
                                <div class="template-action-buttons">
                                    <div class="btn-group w-100">
                                        <button type="button" class="btn dropdown-toggle" data-bs-toggle="dropdown"
                                                ...
                                                class="fa-solid fa-download table-action-buttons table-action-buttons-big edit-action-button"></i>
                                        </button>
                                        <div class="dropdown-menu" aria-labelledby="export"
                                             data-popper-placement="bottom-start">
                                            <a class="dropdown-item" id="copy-text"><i
                                                    class="fa-solid fa-copy fs-13 text-muted mr-2"></i> <?php echo e(__('Copy Text')); ?>
                                            </a>
                                            <a class="dropdown-item" id="copy-html"><i
                                                    class="fa-brands fa-html5 fs-13 text-muted mr-2"></i><?php echo e(__('Copy HTML')); ?>
                                            </a>
                                            <a class="dropdown-item" id="export-text" onclick="exportTXTEditor();"><i
                                                    class="fa-solid fa-text-size fs-13 text-muted mr-2"></i><?php echo e(__('Text File')); ?>
                                            </a>
                                            <a class="dropdown-item" id="export-word" onclick="exportWordEditor();"><i
                                                    class="fa-sharp fa-solid fa-file-word fs-13 text-muted mr-2"></i><?php echo e(__('MS Word')); ?>
                                            </a>

                                        </div>
                                    </div>
                                </div>
                                <a id="save-button-template" class="template-button" onclick="return saveText(this);"
                                   href="#"><i
                                        class="fa-solid fa-floppy-disk-pen table-action-buttons table-action-buttons-big delete-action-button"
                                        data-tippy-content="<?php echo e(__('Save Document')); ?>"></i></a>
                            </div>
                        </div>
                    ...
                    <div>
                        <div id="template-textarea">
                            ...
                            <div>
                                <p class="text-muted fs-12 total-words-templates-box"><?php echo e(__('Total Words')); ?>
                                    : <span id="total-words-templates"></span></p>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u312848366/domains/bestartup.ai/public_html/resources/views/user/rewriter/index.blade.php ENDPATH**/ ?>