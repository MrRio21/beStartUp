...
<form id="openai-form" action="" method="GET" enctype="multipart/form-data" class="mt-24">
    ...
    <div class="row justify-content-md-center">
        <div class="col-sm-12 text-center d-flex justify-content-start align-items-center">
            <h3 class="card-title  fs-28 mb-3 "><i
                    class="fa-solid fa-brain-circuit mr-2 text-primary"></i><?php echo e(__('AI Vision')); ?></h3>
            ...
            <div class="chat-sidebar-container">
                <div class="chat-sidebar-search">
                    <div class="input-box relative">
                        <input id="chat-search" class="form-control" type="text"
                ...
                <div class="chat-sidebar-messages">
                    ...
                    foreach ($__currentLoopData as $key => $message): $__env->incrementLoopIndices();
                        ...
                        <div class="chat-sidebar-message <?php if ($loop->first): ?> selected-message <?php endif; ?>"
                            ...
                            <div class="chat-info">
                                <div class="chat-count">
                                    <span><?php echo e($message->messages); ?></span> <?php echo e(__('messages')); ?>
                                </div>
                                <div
                                    class="chat-date"><?php echo e(\Carbon\Carbon::parse($message->updated_at)->diffForhumans()); ?></div>
                            </div>
                            <div class="chat-actions d-flex">
                                ...
                                <a href="#" class="chat-delete fs-12 ml-2"
                                   id="<?php echo e($message->conversation_id); ?>"><i
                    ...
                    <div class="w-100 pt-2 pb-2">
                        <div class="d-flex">
                            <div class="overflow-hidden mr-4"><img alt="Avatar" class="chat-avatar"
                                                                   src="<?php echo e(URL::asset($chat->logo)); ?>">
                            </div>
                                    ...
                                    <div class="image-drop-area text-center">
                                        <div class="msg left-msg text-center mt-9">
                                            <div class="message-img"
                                                 style="background-image: url(<?php echo e($chat->logo); ?>)"></div>
                                            <div class="message-bubble">
                                                <div
                                                    class="msg-text"><?php echo e(__('Hey there, I can help you with analyzing any image that you upload')); ?></div>
                                            </div>
                                        </div>
                                        ...
                                        <p class="text-dark fw-bold mb-2 mt-3">
                                            ...
                                            <a href="javascript:void(0);"
                                               class="text-primary"><?php echo e(__('Browse')); ?></a>
                                        </p>
                                        <p class="mb-0 file-name text-muted">
                                            <small><?php echo e(__('Allowed image formats')); ?>: .png .jpeg
                                                .webp</small>
                                        </p>
                                        <p class="mb-0 file-name text-muted">
                        ...
                        <div class="col-sm-12">
                            <div class="input-box mb-0">
                                <div class="chat-controllers">
                                    ...
                                    unset($__errorArgs, $__bag); ?>" rows="1" id="message" name="message"
                                    ...
                                    <div class="chat-button-box"><a class="btn chat-button-icon"
                                                                    href="javascript:void(0)" id="prompt-button"
                                    ...
                                    <div class="chat-button-box no-margin-right"><a class="btn chat-button-icon"
                                                                                    href="javascript:void(0)"
                                                                                    id="stop-button"><i
                                                class="fa-solid fa-circle-stop"></i></a></div>
                                    <div>
                                        <button class="btn chat-button" id="chat-button"><?php echo e(__('Send')); ?> <i
                                                class="fa-solid fa-paper-plane-top ml-1"></i></button>
                                    </div>
                                </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body pl-5 pr-5">
                <h6 class="text-center font-weight-extra-bold fs-16"><i
                        class="fa-solid fa-notebook mr-2"></i> <?php echo e(__('Prompt Library')); ?></h6>
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="all" role="tabpanel" aria-labelledby="all-tab">
                            <div class="row" id="templates-panel">
                                <?php $__currentLoopData = $prompts;
                                $__env->addLoop($__currentLoopData);
                                foreach ($__currentLoopData as $prompt): $__env->incrementLoopIndices();
                                    $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u312848366/domains/bestartup.ai/public_html/resources/views/user/vision/index.blade.php ENDPATH**/ ?>