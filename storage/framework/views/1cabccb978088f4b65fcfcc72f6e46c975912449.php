...
<form id="wizard-form" action="" method="post" enctype="multipart/form-data" class="mt-24">
	...
	<div class="row justify-content-center">
		<div class="col-sm-12 col-md-10 text-center">
			<h3 class="card-title fs-20 mb-0 super-strong text-left pb-7"><?php echo e(__('AI Article Wizard')); ?></h3>
		</div>

		<div class="row justify-content-center">
			<div class="col-lg-4 col-md-12 col-sm-12">
				<div class="card border-0" id="all-wizard-options">
                    <div class="col-lg-12 col-md-10 col-sm-12 pb-7 pt-7">
                        <div class="wizard-nav">
                            <div class="wizard-nav-inner">
                                <div class="row text-center justify-content-center">
                                    <div class="col-3">
                                        <div class="d-flex wizard-nav-text flex-column " id="step-one-icon">
                                            <div class="wizard-step-number current-step mr-3 fs-14" id="step-one-number">1</div>
                                            <div class="wizard-step-title"><span class="font-weight-bold fs-14"><?php echo e(__('Get Ideas')); ?></span> </div>
                                        </div>
                                        <div>
                                            <!--								<i class="fa-solid fa-chevrons-right wizard-nav-chevron" id="step-one-icon"></i>-->
                                            <!--                                <div class="w-100 bg-blue" style="height: 2px"></div>-->
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="d-flex wizard-nav-text flex-column " id="step-two-icon">
                                            <div class="wizard-step-number mr-3 fs-14" id="step-two-number">2</div>
                                            <div class="wizard-step-title responsive"><span class="font-weight-bold fs-14"><?php echo e(__('Outlines')); ?></span> </div>
                                        </div>
                                        <div>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="d-flex wizard-nav-text flex-column" id="step-three-icon">
                                            <div class="wizard-step-number mr-3 fs-14" id="step-three-number">3</div>
                                            <div class="wizard-step-title"><span class="font-weight-bold fs-14"><?php echo e(__('Talking Points')); ?></span> </div>
                                        </div>
                                        <div>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="d-flex wizard-nav-text flex-column">
                                            <div class="wizard-step-number mr-3 fs-14" id="step-four-number">4</div>
                                            <div class="wizard-step-title responsive"><span class="font-weight-bold fs-14"><?php echo e(__('Images')); ?></span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u312848366/domains/bestartup.ai/public_html/resources/views/user/templates/wizard/index.blade.php ENDPATH**/ ?>