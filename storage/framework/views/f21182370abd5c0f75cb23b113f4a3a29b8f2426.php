							...
							<div id="single-template-view">
								<div class="single-template-options">
									<div class="form-group mb-5">	
										<h6 class="fs-13 mb-2 font-weight-bold"><?php echo e(__('Language')); ?></h6>								
...
unset($__errorArgs, $__bag); ?>	
								...
								<div class="single-template-options">
									...
									<div class="form-group mb-5">
										<h6 class="fs-13 mb-2 font-weight-bold"><?php echo e(__('Writing Tone')); ?> <i class="ml-1 text-dark fs-12 fa-solid fa-circle-info" data-tippy-content="<?php echo e(__('Set result tone of the text as needed')); ?>"></i></h6>
									...
									<div class="form-group mb-5">
										<h6 class="fs-13 mb-2 font-weight-bold"><?php echo e(__('Creativity')); ?> <i class="ml-1 text-dark fs-12 fa-solid fa-circle-info" data-tippy-content="<?php echo e(__('Increase or decrease the creativity level to get variety in generated results')); ?>"></i></h6>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.smart', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u312848366/domains/bestartup.ai/public_html/resources/views/user/smart_editor/index.blade.php ENDPATH**/ ?>