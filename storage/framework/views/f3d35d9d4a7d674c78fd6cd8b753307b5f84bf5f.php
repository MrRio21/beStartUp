			...
			<div class="card overflow-hidden border-0">
				<div class="card-body">
					<div class="d-flex align-items-end justify-content-between ">
                        <span class="fs-40 mt-m1"><i class="fa-solid fa-user"></i></span>
...
<!--                            <p class=" mb-3 fs-12 font-weight-bold">--><?php //echo e(__('Total New Users')); ?><!-- <span class="text-muted">(--><?php //echo e(__('Current Month')); ?><!--)</span></p>-->
							...
							<p class=" mb-3 fs-12 font-weight-bold"><?php echo e(__('Total New Users')); ?> </p>
							<h2 class="mb-0 d-flex flex-column"><span class="number-font fs-20"><?php echo e(number_format($total_data_monthly['new_users_current_month'])); ?></span><span class="ml-2 text-muted fs-11 data-percentage-change"><span id="users_change"></span> <?php echo e(__('this month')); ?></span></h2>
...
<!--					</div>-->
		...
		<div class="col-xl-2 col-lg-6 col-md-12 col-sm-12">
			<div class="card overflow-hidden border-0">
				<div class="card-body">
					<div class="d-flex align-items-end justify-content-between flex-row-reverse">
						<div>
							<p class=" mb-3 fs-12 font-weight-bold"><?php echo e(__('Total New Subscribers')); ?> </p>
		...
		<div class="col-xl-2 col-lg-6 col-md-12 col-sm-12">
			<div class="card overflow-hidden border-0">
				<div class="card-body">
					<div class="d-flex align-items-end justify-content-between flex-row-reverse">
						<div>
							<p class=" mb-3 fs-12 font-weight-bold"><?php echo e(__('Total Income')); ?> </p>
							<h2 class="mb-0 d-flex flex-column"><span class="number-font fs-20"><?php echo config('payment.default_system_currency_symbol'); ?><?php echo e(number_format((float)$total_data_monthly['income_current_month'][0]['data'], 2)); ?></span><span class="ml-2 text-muted fs-11 data-percentage-change"><span id="income_change"></span> <?php echo e(__('this month')); ?></span></h2>
						</div>
		...
		<div class="col-xl-2 col-lg-6 col-md-12 col-sm-12">
			<div class="card overflow-hidden border-0">
				<div class="card-body">
					<div class="d-flex align-items-end justify-content-between flex-row-reverse">
						<div>
							<p class=" mb-3 fs-12 font-weight-bold"><?php echo e(__('Total Estimated Spending')); ?> </p>
							<h2 class="mb-0 d-flex flex-column"><span class="number-font fs-20">$<?php echo e(number_format((float)$total_data_monthly['spending_current_month'], 3, '.', '')); ?></span><span class="ml-2 text-muted fs-11 data-percentage-change"><span class="fs-12" id="spending_change"></span> <?php echo e(__('this month')); ?></span></h2>
						</div>
        ...
        <div class="col-lg-2 col-md-6 col-sm-12">
            <div class="card overflow-hidden border-0">
                <div class="card-body">
                    <div class="d-flex align-items-end justify-content-between flex-row-reverse">
                        <div>
                            <p class=" mb-3 fs-12 font-weight-700"><?php echo e(__('Total Words Generated')); ?></p>
                            <h2 class="mb-0 flex-column d-flex"><span class="number-font fs-20"><?php echo e(number_format($total_data_monthly['words_current_month'])); ?></span><span class="ml-2 text-muted fs-11 data-percentage-change"><span id="words_change"></span> <?php echo e(__('this month')); ?></span></h2>
        ...
        <div class="col-lg-2 col-md-6 col-sm-12">
            <div class="card overflow-hidden border-0">
                <div class="card-body">
                    <div class="d-flex align-items-end justify-content-between flex-row-reverse">
                        <div>
                            <p class=" mb-3 fs-12 font-weight-700"><?php echo e(__('Total Images Generated')); ?> </p>
                            <h2 class="mb-0 d-flex flex-column"><span class="number-font fs-20"><?php echo e(number_format($total_data_monthly['images_current_month'])); ?></span><span class="ml-2 text-muted fs-11 data-percentage-change"><span id="images_change"></span> <?php echo e(__('this month')); ?></span></h2>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u312848366/domains/bestartup.ai/public_html/resources/views/admin/dashboard/index.blade.php ENDPATH**/ ?>