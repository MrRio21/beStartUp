...
<form id="openai-form" action="" method="GET" enctype="multipart/form-data" class="mt-24">
		...
		<div class="row justify-content-md-center">
			<div class="col-sm-12 text-center d-flex justify-content-start align-items-center">
				<h3 class="card-title fs-28 mb-3 ">
				  <?php echo e(__('AI Chat PDF')); ?>

				</h3>
				<h6 class="mb-0 fs-12 text-muted"><?php echo e(__('Unleash the Power of your PDF documents with the help of AI')); ?></h6>
					...
					<div class="card-footer">
						<div class="row text-center">
							<div class="col-sm-12">
								...
								<a class="btn btn-primary pl-6 pr-6 fs-12 mt-1" id="upload-pdf-button" href="javascript:void(0);"><?php echo e(__('Upload PDF File')); ?></a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="chat-message-container" id="chat-system">
					<div class="card-header">
						<div class="w-100 pt-2 pb-2">
							<div class="d-flex">
								<div class="overflow-hidden mr-4"><img alt="Avatar" class="chat-avatar" src="<?php echo e(URL::asset('/chats/filebot.jpg')); ?>"></div>
								<div class="widget-user-name"><span class="font-weight-bold"><?php echo e(__('AI PDF')); ?></span><br><span class="text-muted"><?php echo e(__('PDF Analyst Expert')); ?></span></div>
							</div>
						</div>
								...
								<div id="chat-container">
									<div class="msg left-msg" id="intro-drop-box">
										...
										<div class="message-bubble">
											<div class="msg-text"><?php echo e(__('Hey there, I can help you get any insights out of your PDF documents, what would you like to know?')); ?></div>
										</div>
									</div>
									<div id="image-drop-box">
										<div class="image-drop-area text-center">
											<div class="msg left-msg text-center mt-9">
												<div class="message-img" style="background-image: url('/chats/filebot.jpg')"></div>
												<div class="message-bubble">
													<div class="msg-text"><?php echo e(__('Hey there, I can help you with analyzing any PDF documents that share with me')); ?></div>
													<div class="msg-text"><?php echo e(__('Select and upload your PDF documents to get started')); ?></div>
												</div>
											</div>
										</div>
									</div>
...
<script type="text/javascript">
	...
	const bot_avatar = "<?php echo e(URL::asset('/chats/filebot.jpg')); ?>";	
	...
	var fileLimit = "<?php echo e($limit); ?>"; 
	...
	$(function () {		
		main_form.addEventListener("submit", event => {
			...
			if (!start_chat) {
				toastr.warning('<?php echo e(__('Upload a valid PDF document before analyzing')); ?>');
				return;
			}
	...
	input_pdf.addEventListener('change', function(){
		...
		if(fileSizeInKB < fileLimit){
			...
			toastr.warning('<?php echo e(__('Selected PDF file is too big. ')); ?><?php echo e(__('Maximum allowed file size is ')); ?>'+fileLimit+'MB');
		}
	});
	...
	function analyze(files) {
        ...
        fetch("/user/chat/pdf/embedding", {
            ...
            .then(async (res) => {
                ...
                btn.innerHTML = "<?php echo e(__('Upload PDF File')); ?>";
            })
            .catch((e) => {
				$('#image-drop-box').removeClass('hidden');
				$('#progress-drop-box').addClass('hidden');
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u312848366/domains/bestartup.ai/public_html/resources/views/user/chat_pdf/index.blade.php ENDPATH**/ ?>